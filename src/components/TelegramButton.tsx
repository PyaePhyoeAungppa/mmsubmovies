...
export default function TelegramButton({ href, id }: TelegramButtonProps) {
  return (
    <div className="group/btn relative inline-block">
      ...
      <a
        ...
        className="relative flex items-center gap-2 bg-gradient-to-r from-[#0088cc] to-[#33b5f5] text-white px-5 py-3 rounded-2xl font-black text-sm shadow-xl hover:shadow-[#0088cc]/40 hover:-translate-y-1 transition-all active:scale-95 overflow-hidden"
      >
